package net.crypticarc.abyssal.block;

import net.crypticarc.abyssal.ChaosAbyssal;
import net.crypticarc.abyssal.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, ChaosAbyssal.MOD_ID);
